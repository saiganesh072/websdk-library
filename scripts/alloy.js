...
(function () {
  ...
  */
  ...
  /*
  crc32 路 JavaScript Function to Calculate CRC32 of a String
  Description
    ...
    (function (root, factory) {
      ...
      var cssEscape = function cssEscape(value) {
        ...
        while (++index < length) {
          ...
          // Note: there鈥檚 no need to special-case astral symbols, surrogate
          ...
          // (U+0030 to U+0039) and the first character is a `-` (U+002D), [鈥
          ...
          // there is no second character, [鈥
          ...
          // U+005A), or [a-z] (U+0061 to U+007A), [鈥
