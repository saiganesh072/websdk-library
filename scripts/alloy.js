...
var areThirdPartyCookiesSupportedByDefault = function areThirdPartyCookiesSupportedByDefault(
  browser
) {
      ...
      Object.keys(currentValue).forEach(function (key) {
        if (Array.isArray(currentValue[key])) {
          if (Array.isArray(accumulator[key])) {
            ...
            (_accumulator$key = accumulator[key]).push.apply(
              _accumulator$key,
              _toConsumableArray(currentValue[key])
            );
          } else {
...
var deduplicateArray = function deduplicateArray(array) {
  var isEqual =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : REFERENCE_EQUALITY;
...
var awaitSelector = function awaitSelector(selector) {
  ...
  var timeout =
    arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : MAX_POLLING_TIMEOUT;
...
var getNamespacedCookieName = function getNamespacedCookieName(orgId, key) {
  return ""
    .concat(COOKIE_NAME_PREFIX, "_")
    .concat(sanitizeOrgIdForCookieName(orgId), "_")
    .concat(key);
};
...
var isNamespacedCookieName = function isNamespacedCookieName(orgId, name) {
  return (
    name.indexOf(
      "".concat(COOKIE_NAME_PREFIX, "_").concat(sanitizeOrgIdForCookieName(orgId), "_")
    ) === 0
  );
};
...
var parseUrl = function parseUrl(url) {
  var parseDomain =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : parseDomainBasic;
  if (!isString(url)) {
 ...
 * @returns {function}
 */
var callSequentiallyJoinErrors = function callSequentiallyJoinErrors(
  firstValidator,
  secondValidator
) {
 ...
 * @returns {function}
 */
var reverseNullSafeChainJoinErrors = function reverseNullSafeChainJoinErrors(
  baseValidator,
  newValidator,
  additionalMethods
) {
...
var assertValid = function assertValid(isValid, value, path, message) {
  if (!isValid) {
    throw new Error(
      "'"
        .concat(path, "': Expected ")
        .concat(message, ", but got ")
...
var createDeprecatedValidator = function createDeprecatedValidator(oldField, oldSchema, newField) {
  return function deprecated(value, path) {
    ...
    if (validatedOldValue !== undefined) {
      var message = "The field '"
        .concat(oldField, "' is deprecated. Use '")
        .concat(newField, "' instead.");
      if (path) {
...
var createMinimumValidator = function createMinimumValidator(typeName, minimum) {
  return function (value, path) {
    assertValid(
      ...
      value,
      path,
      "".concat(typeName, " greater than or equal to ").concat(minimum)
    );
    return value;
  };
};
...
var boundEnumOf = function boundEnumOf() {
  ...
  return boundAnyOf(
    ...
    "one of these values: [".concat(JSON.stringify(values), "]")
  );
};
...
var createComponentRegistry = function createComponentRegistry() {
  ...
  var registerComponentCommands = function registerComponentCommands(namespace) {
    ...
    if (conflictingCommandNames.length) {
      throw new Error(
        "[ComponentRegistry] Could not register ".concat(namespace, " ") +
          "because it has existing command(s): ".concat(conflictingCommandNames.join(","))
      );
    }
    Object.keys(componentCommandsByName).forEach(function (commandName) {
      ...
      command.run = wrapForErrorHandling(
        command.run,
        "["
          .concat(namespace, "] An error occurred while executing the ")
          .concat(commandName, " command.")
      );
    ...
    Object.keys(componentLifecycleCallbacksByName).forEach(function (hookName) {
      ...
      lifecycleCallbacksByName[hookName].push(
        wrapForErrorHandling(
          ...
          "["
            .concat(namespace, "] An error occurred while executing the ")
            .concat(hookName, " lifecycle hook.")
        )
      );
    });
  };
...
var createEvent = function createEvent() {
  ...
  var event = {
    ...
    finalize: function finalize(onBeforeEventSend) {
      ...
      var newPropositions = deduplicateArray(
        [].concat(
          _toConsumableArray(getXdmPropositions(userXdm)),
          _toConsumableArray(getXdmPropositions(content.xdm))
        ),
        function (a, b) {
          return (
            a === b || (a.id && b.id && a.id === b.id && a.scope && b.scope && a.scope === b.scope)
          );
        }
      );
      if (userXdm) {
          ...
          return configurePromise.then(
            function (componentRegistry) {
              ...
              if (!command || !isFunction(command.run)) {
                ...
                throw new Error(
                  "The "
                    .concat(commandName, " command does not exist. List of available commands: ")
                    .concat(commandNames, ".")
                );
              }
...
var validateCommandOptions = function validateCommandOptions(_ref20) {
  ...
  if (optionsValidator) {
    try {
      ...
      var invalidOptionsMessage = "Invalid "
        .concat(commandName, " command options:\n\t - ")
        .concat(validationError, " For command documentation see: ")
        .concat(documentationUri);
      ...
      sendEvent: {
        ...
        run: function run(options) {
          var xdm = options.xdm,
            ...
            eventManagerOptions = _objectWithoutProperties(options, [
              "xdm",
              "data",
              "documentUnloading",
              "type",
...
governing permissions and limitations under the License.
*/
var downloadLinkQualifier = boundString()
  .regexp()
...
governing permissions and limitations under the License.
*/
var injectSetDomainForInitialIdentityPayload = function injectSetDomainForInitialIdentityPayload(
  _ref43
) {
...
var injectAddQueryStringIdentityToPayload = function injectAddQueryStringIdentityToPayload(_ref45) {
  ...
  return function (payload) {
    ...
    if (
      ...
      logger.info(
        "Found valid ECID identity ".concat(mcmid, " from the adobe_mc query string parameter.")
      );
...
var createHasIdentity = function createHasIdentity(content) {
  return function (namespaceCode) {
    return (
      (content.xdm && content.xdm.identityMap && content.xdm.identityMap[namespaceCode]) !==
      undefined
    );
  };
};
...
var createGetAssuranceValidationTokenParams = function createGetAssuranceValidationTokenParams(
  _ref53
) {
  ...
  return function () {
    ...
    return "&".concat(
      _reactorQueryString["default"].stringify({
...
var injectAppendIdentityToUrl = function injectAppendIdentityToUrl(_ref57) {
  ...
  return function (ecid, url) {
    ...
    var adobemc = encodeURIComponent(
      "TS=".concat(ts, "|MCMID=").concat(ecid, "|MCORGID=").concat(encodeURIComponent(orgId))
    );
...
var createResultLogMessage$1 = function createResultLogMessage$1(urlDestination, success) {
  return "URL destination "
    .concat(success ? "succeeded" : "failed", ": ")
    .concat(urlDestination.spec.url);
};
...
var stringifySurface = function stringifySurface(surface) {
  return ""
    .concat(surface.surfaceType)
    .concat(SURFACE_TYPE_DELIMITER)
    .concat(surface.authority)
    .concat(surface.path || "")
    .concat(surface.fragment || "");
};
...
var validateSurface = function validateSurface(surface, getPageLocation, logger) {
  ...
  if (!includes([WEB, WEBAPP], parsed.surfaceType)) {
    return invalidateSurface(
      "Unsupported surface type ".concat(parsed.surfaceType, " in surface: ").concat(surface)
    );
  }
  if (!parsed.authority || !AUTHORITY_REGEX.test(parsed.authority)) {
    return invalidateSurface(
      "Invalid authority ".concat(parsed.authority, " in surface: ").concat(surface)
    );
  }
  ...
  if (parsed.fragment && !FRAGMENT_REGEX.test(parsed.fragment)) {
    return invalidateSurface(
      "Invalid fragment ".concat(parsed.fragment, " in surface: ").concat(surface)
    );
  }
  return parsed;
};
  ...
  return {
    ...
    shouldRequestDefaultPersonalization: function shouldRequestDefaultPersonalization() {
      return (
        ...
        (!this.isCacheInitialized() && personalization.defaultPersonalizationEnabled !== false)
      );
    },
  };
};
...
var eventTypeToPropositionEventTypeMapping =
  ((_eventTypeToPropositi = {}),
  _defineProperty(_eventTypeToPropositi, DISPLAY, PropositionEventType.DISPLAY),
  _defineProperty(_eventTypeToPropositi, INTERACT, PropositionEventType.INTERACT),
  _defineProperty(_eventTypeToPropositi, TRIGGER, PropositionEventType.TRIGGER),
  _defineProperty(_eventTypeToPropositi, DISMISS, PropositionEventType.DISMISS),
  _eventTypeToPropositi);
  ...
  return function (_ref73) {
    var _ref73$decisionsMeta = _ref73.decisionsMeta,
      ...
      propositionEventTypes =
        _ref73$propositionEve === void 0
          ? [getPropositionEventType(eventType)]
          : _ref73$propositionEve,
...
var createFetchDataHandler = function createFetchDataHandler(_ref74) {
  ...
  return function (_ref75) {
    ...
    onResponse(function (_ref76) {
      ...
      if (personalizationDetails.isRenderDecisions()) {
        var _processPropositions = processPropositions(
          [].concat(
            _toConsumableArray(pagePropositions),
            _toConsumableArray(currentViewPropositions)
          ),
        ...
        var _processPropositions2 = processPropositions(
          [],
          [].concat(
            _toConsumableArray(pagePropositions),
            _toConsumableArray(currentViewPropositions),
            _toConsumableArray(nonRenderedPropositions)
          )
        );
  ...
  return function (_ref86) {
    ...
    return Promise.resolve()
      ...
      .then(function (additionalPropositions) {
        var _processPropositions5 = processPropositions(
            [].concat(
              _toConsumableArray(propositionsToExecute),
              _toConsumableArray(additionalPropositions)
            )
          ),
...
var injectCreateProposition = function injectCreateProposition(_ref89) {
  ...
  return function (payload) {
    ...
    return {
      ...
      addToReturnValues: function addToReturnValues(
        propositions,
        decisions,
        includedItems,
        renderAttempted
  ...
  return function (item) {
    ...
    if (type === "click") {
      ...
      storeClickMetrics({
        selector: selector,
        meta: _objectSpread(
          _objectSpread({}, item.getProposition().getNotification()),
          {},
          {
        ...
        ["catch"](function (error) {
          if (logger.enabled) {
            var message = error.message,
              stack = error.stack;
            var warning = "Failed to execute action "
  ...
  if (contentType === APPLICATION_JSON) {
    for (var _i14 = 0; _i14 < expectedContentProps.length; _i14 += 1) {
      ...
      if (!Object.prototype.hasOwnProperty.call(content, _prop)) {
        logger.warn(
          "Invalid in-app message data.content: missing property '".concat(_prop, "'."),
          data
        );
        return false;
      }
...
var createIframeClickHandler = function createIframeClickHandler(interact) {
  var navigateToUrl =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : createRedirect(window);
...
var buildStyleFromMobileParameters = function buildStyleFromMobileParameters(mobileParameters) {
  ...
  if (verticalAlign === "top") {
    ...
    style.top = "50%";
    style.transform = "".concat(
      horizontalAlign === "center" ? "".concat(style.transform, " ") : "",
      "translateY(-50%)"
    );
    style.display = "flex";
...
var generateWebParameters = function generateWebParameters(mobileParameters) {
  ...
  return (
    (_ref104 = {}),
    _defineProperty(_ref104, IFRAME_ID, {
      style: {
        border: "none",
        width: "100%",
        height: "100%",
...
var createPersonalization = function createPersonalization(_ref105) {
  ...
  var schemaProcessors =
    ((_schemaProcessors = {}),
    _defineProperty(_schemaProcessors, DEFAULT_CONTENT_ITEM, processDefaultContent),
    _defineProperty(
      _schemaProcessors,
      DOM_ACTION,
      createProcessDomAction({
...
var injectDevice = function injectDevice(window) {
  return function (xdm) {
    ...
    var orientation =
      getScreenOrientationViaProperty(window) || getScreenOrientationViaMediaQuery(window);
    if (orientation) {
...
governing permissions and limitations under the License.
*/
var createComponent$2 = function createComponent$2(
  config,
  logger,
  optionalContexts,
  requiredContexts
    ...
    try {
      return navigator.userAgentData
        .getHighEntropyValues(
          highEntropyUserAgentHints.map(function (hint) {
            return hint[0];
          })
        )
        .then(function (hints) {
...
var optionalContexts = _objectSpread(
  _objectSpread({}, defaultEnabledContexts),
...
var createPrivacy = function createPrivacy(_ref118) {
  ...
  var storage = createNamespacedStorage(
    "".concat(sanitizeOrgIdForCookieName(orgId), ".consentHashes.")
  );
...
var prepareLibraryInfo = function prepareLibraryInfo(_ref120) {
  ...
  var allCommands = []
    .concat(_toConsumableArray(componentRegistry.getCommandNames()), [CONFIGURE, SET_DEBUG])
    .sort();
...
var isPlainObject = function isPlainObject(obj) {
  return (
    obj !== null && _typeof(obj) === "object" && Object.getPrototypeOf(obj) === Object.prototype
  );
};
...
var createOnResponseHandler = function createOnResponseHandler(_ref122) {
  ...
  var context = _objectSpread(
    _objectSpread({}, flattenObject$1(event.getContent())),
    decisionContext
  );
  ...
  return {
    matches: function matches(context, key) {
      ...
      for (var _i16 = 0; _i16 < values.length; _i16 += 1) {
        if (
          !isObjectOrUndefined(values[_i16]) &&
          contextValue === String(values[_i16]).toLowerCase()
        ) {
          return true;
        }
      }
  ...
  return {
    matches: function matches(context, key) {
      ...
      for (var _i17 = 0; _i17 < values.length; _i17 += 1) {
        if (
          !isObjectOrUndefined(values[_i17]) &&
          contextValue === String(values[_i17]).toLowerCase()
        ) {
          return false;
        }
      }
  ...
  return {
    matches: function matches(context, key) {
      ...
      for (var _i22 = 0; _i22 < values.length; _i22 += 1) {
        if (
          !isObjectOrUndefined(values[_i22]) &&
          contextValue.indexOf(String(values[_i22]).toLowerCase()) !== -1
        ) {
          return true;
        }
      }
  ...
  return {
    matches: function matches(context, key) {
      ...
      for (var _i23 = 0; _i23 < values.length; _i23 += 1) {
        if (
          !isObjectOrUndefined(values[_i23]) &&
          contextValue.indexOf(String(values[_i23]).toLowerCase()) !== -1
        ) {
          return false;
        }
      }
  ...
  return {
    matches: function matches(context, key) {
      ...
      for (var _i24 = 0; _i24 < values.length; _i24 += 1) {
        if (
          !isObjectOrUndefined(values[_i24]) &&
          contextValue.startsWith(String(values[_i24]).toLowerCase())
        ) {
          return true;
        }
      }
  ...
  return {
    matches: function matches(context, key) {
      ...
      for (var _i25 = 0; _i25 < values.length; _i25 += 1) {
        if (
          !isObjectOrUndefined(values[_i25]) &&
          contextValue.endsWith(values[_i25].toLowerCase())
        ) {
          return true;
        }
      }
...
var MATCHERS =
  ((_MATCHERS = {}),
  _defineProperty(_MATCHERS, MatcherType.EQUALS, createEquals()),
  _defineProperty(_MATCHERS, MatcherType.NOT_EQUALS, createNotEquals()),
  _defineProperty(_MATCHERS, MatcherType.EXISTS, createExists()),
  _defineProperty(_MATCHERS, MatcherType.NOT_EXISTS, createNotExists()),
  _defineProperty(_MATCHERS, MatcherType.GREATER_THAN, createGreaterThan()),
  _defineProperty(_MATCHERS, MatcherType.GREATER_THAN_OR_EQUAL_TO, createGreaterThanEquals()),
  _defineProperty(_MATCHERS, MatcherType.LESS_THAN, createLessThan()),
  _defineProperty(_MATCHERS, MatcherType.LESS_THAN_OR_EQUAL_TO, createLessThanEquals()),
  _defineProperty(_MATCHERS, MatcherType.CONTAINS, createContains()),
  _defineProperty(_MATCHERS, MatcherType.NOT_CONTAINS, createNotContains()),
  _defineProperty(_MATCHERS, MatcherType.STARTS_WITH, createStartsWith()),
  _defineProperty(_MATCHERS, MatcherType.ENDS_WITH, createEndsWith()),
  _MATCHERS);
...
function queryAndCountOrderedEvent(events, context, from, to) {
  ...
  var sameSequence = events.every(function (event) {
    ...
    var ordered =
      (isUndefined(previousEventTimestamp) || contextEvent.timestamp >= previousEventTimestamp) &&
...
var adapters =
  ((_adapters = {}),
  _defineProperty(_adapters, CJM_IN_APP_MESSAGE_TYPE, inAppMessageConsequenceAdapter),
  _defineProperty(_adapters, SCHEMA, schemaTypeConsequenceAdapter),
  _adapters);
...
var createEvaluableRulesetPayload = function createEvaluableRulesetPayload(
  payload,
  eventRegistry,
  decisionHistory
) {
  ...
  var evaluate = function evaluate(context) {
    ...
    var qualifyingItems = flattenArray(
...
var createDecisionProvider = function createDecisionProvider(_ref126) {
  ...
  var addPayload = function addPayload(payload) {
    ...
    var evaluableRulesetPayload = createEvaluableRulesetPayload(
      payload,
      eventRegistry,
      decisionHistory
    );
  ...
  var evaluate = function evaluate() {
    ...
    return Object.values(payloadsBasedOnActivityId)
...
var createEventPruner = function createEventPruner() {
  ...
  var retentionPeriod =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : RETENTION_PERIOD;
...
var createEventRegistry = function createEventRegistry(_ref128) {
  ...
  var addEvent = function addEvent(event, eventType, eventId, action) {
    ...
    var firstTimestamp = existingEvent
    ...
    events[eventType][eventId] = {
      event: _objectSpread(
        ...
        {},
        ((_objectSpread5 = {}),
        _defineProperty(_objectSpread5, prefixed("id"), eventId),
        _defineProperty(_objectSpread5, prefixed("eventType"), eventType),
        _defineProperty(_objectSpread5, prefixed("action"), action),
        _objectSpread5)
      ),
  ...
  var addExperienceEdgeEvent = function addExperienceEdgeEvent(event) {
    ...
    propositionEventTypesList
      ...
      .forEach(function (propositionEventType) {
...
var createContextProvider = function createContextProvider(_ref129) {
  ...
  var getGlobalContext = function getGlobalContext() {
    return _objectSpread(
      _objectSpread(_objectSpread({}, coreGlobalContext), getTimeContext()),
      {},
      {
  ...
  var getContext = function getContext() {
    ...
    return _objectSpread(
      _objectSpread({}, flattenObject$1(context)),
      {},
      {
...
var defaultPreprocessor = function defaultPreprocessor(params) {
  for (
    var _len7 = arguments.length, args = new Array(_len7 > 1 ? _len7 - 1 : 0), _key7 = 1;
    _key7 < _len7;
    _key7++
  ) {
...
var createDecisioningEngine = function createDecisioningEngine(_ref136) {
  ...
  var storage = createNamespacedStorage(
    "".concat(sanitizeOrgIdForCookieName(orgId), ".decisioning.")
  );
        ...
        onResponse(
          createOnResponseHandler({
            ...
            decisionContext: contextProvider.getContext(
              _objectSpread(
                ((_objectSpread6 = {}),
                _defineProperty(_objectSpread6, CONTEXT_KEY.TYPE, CONTEXT_EVENT_TYPE.EDGE),
                _defineProperty(_objectSpread6, CONTEXT_KEY.SOURCE, CONTEXT_EVENT_SOURCE.REQUEST),
                _objectSpread6),
                decisionContext
              )
            ),
        ...
        run: function run(_ref139) {
          ...
          return evaluateRulesetsCommand.run({
            ...
            decisionContext: _objectSpread(
              ((_objectSpread7 = {}),
              _defineProperty(_objectSpread7, CONTEXT_KEY.TYPE, CONTEXT_EVENT_TYPE.RULES_ENGINE),
              _defineProperty(_objectSpread7, CONTEXT_KEY.SOURCE, CONTEXT_EVENT_SOURCE.REQUEST),
              _objectSpread7),
              decisionContext
            ),
            applyResponse: applyResponse,
...
var buildAllOnInstanceConfiguredExtraParams = function buildAllOnInstanceConfiguredExtraParams(
  ...
  return componentCreators.reduce(function (memo, _ref142) {
    ...
    if (buildOnInstanceConfiguredExtraParams) {
      (0, _reactorObjectAssign["default"])(
        memo,
...
var buildAndValidateConfig = function buildAndValidateConfig(_ref144) {
  ...
  var combinedConfigValidator = componentCreators
    .map(function (_ref145) {
...
var createLogger = function createLogger(_ref151) {
  ...
  var log = function log(level) {
    for (
      var _len10 = arguments.length, rest = new Array(_len10 > 1 ? _len10 - 1 : 0), _key10 = 1;
      _key10 < _len10;
      _key10++
    ) {
  ...
  return {
    ...
    logOnNetworkResponse: function logOnNetworkResponse(data) {
      ...
      log(
        "info",
        "Request "
          .concat(data.requestId, ": Received response with status code ")
          .concat(data.statusCode, " and ")
          .concat(messagesSuffix),
  ...
  return {
    ...
    responseToCookies: function responseToCookies(response) {
      response.getPayloadsByType(STATE_STORE_HANDLE_TYPE).forEach(function (stateItem) {
        ...
        var sameSite =
          stateItem.attrs && stateItem.attrs.SameSite && stateItem.attrs.SameSite.toLowerCase();
...
var mergeLifecycleResponses = function mergeLifecycleResponses(returnValues) {
  ...
  return assignConcatArrayValues.apply(
    void 0,
    [{}].concat(
  ...
  return function (_ref156) {
    var request = _ref156.request,
      ...
      runOnRequestFailureCallbacks =
        _ref156$runOnRequestF === void 0 ? noop : _ref156$runOnRequestF;
    var onResponseCallbackAggregator = createCallbackAggregator();
    ...
    return lifecycle
      ...
      .then(function () {
        ...
        var edgeBasePathWithLocationHint = locationHint
          ? "".concat(edgeBasePath, "/").concat(locationHint)
          : edgeBasePath;
        ...
        var url = "https://"
          .concat(endpointDomain, "/")
          .concat(edgeBasePathWithLocationHint, "/")
          .concat(apiVersion, "/")
          .concat(request.getAction(), "?configId=")
          .concat(configId, "&requestId=")
          .concat(request.getId())
          .concat(getAssuranceValidationTokenParams());
...
var injectProcessWarningsAndErrors = function injectProcessWarningsAndErrors(_ref158) {
  ...
  return function (networkResponse) {
    ...
    if (
      ...
      throw new Error(
        "".concat(MESSAGE_PREFIX, " status code ").concat(statusCode, " and ").concat(messageSuffix)
      );
    }
    if (parsedBody) {
...
var injectApplyResponse = function injectApplyResponse(_ref162) {
  ...
  return function (_ref163) {
    var request = _ref163.request,
      ...
      runOnRequestFailureCallbacks =
        _ref163$runOnRequestF === void 0 ? noop : _ref163$runOnRequestF;
    var onResponseCallbackAggregator = createCallbackAggregator();
    onResponseCallbackAggregator.add(lifecycle.onResponse);
    onResponseCallbackAggregator.add(runOnResponseCallbacks);
    var onRequestFailureCallbackAggregator = createCallbackAggregator();
